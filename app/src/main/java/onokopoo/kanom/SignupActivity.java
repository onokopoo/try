...
public class SignupActivity extends AppCompatActivity {
    ...
    private void register(String username, String password, String email) {
        class RegisterUser extends AsyncTask<String, Void, String> {
            ...
            SignupActivity ruc = new SignupActivity();
            ...
            protected String doInBackground(String... params) {
                ...
                params1.add(new BasicNameValuePair("username", params[0]));
                params1.add(new BasicNameValuePair("password", params[1]));
                params1.add(new BasicNameValuePair("email", params[2]));

                try {
                    JSONArray data = new JSONArray(getJSONUrl(Config.URL_REGISTER,params1));
